...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Pre-departure Training" wrapperCls="home_1">
                <div>
                                ...
                                <div className="col-lg-8 content-side">
                                    ...
                                    <div className="row mb-5">
                                        <div className="col-md-5">
                                            <h2>Pre-depature Training</h2>
                                            <div className="icon"><span className="flaticon-chart" /></div>
                                        </div>
                                        <div className="col-md-7">
                                            <div className="text"><p>Our Pre-departure Training program equips you with the knowledge and skills necessary for a smooth and successful transition abroad. </p></div>
                                            <ul className="list">
                                                <li><i className="fa fa-check" />Program customization</li>
                                                <li><i className="fa fa-check" />Cultural norms and etiquette</li>
                                                <li><i className="fa fa-check" />Language basics</li>
                                                <li><i className="fa fa-check" />Practical considerationst</li>
                                                <li><i className="fa fa-check" />Safety and security tips</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <h5>Target Audience: Individuals preparing for international travel, including students, volunteers, professionals, and migrants.</h5>
                                    {/*Theme Carousel*/}
                                    {/* <ServiceSlider1 /> */}
                                    <h5>Gain a comprehensive understanding of the destination country’s culture, customs, and social norms.</h5>
                                    <div className="text">This curriculum can be adapted to be delivered in various formats, ranging from intensive week-long workshops to a series of shorter modules spread over several weeks. The specific duration will depend on the needs and goals of the participants.</div>
                                    <ServiceTabs1 />
                                </div>
