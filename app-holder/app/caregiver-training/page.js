...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Caregiver & Training" wrapperCls="home_1">
                <div>
                                ...
                                <div className="col-lg-8 content-side">
                                    ...
                                    <div className="row mb-5">
                                        ...
                                        <div className="col-md-7">
                                            <div className="text"><p>Our Caregiver Training program equips you with the knowledge, skills, and compassion to care for individuals of all ages and needs in their homes. </p></div>
                                            <ul className="list">
                                                <li><i className="fa fa-check" />Personal care</li>
                                                <li><i className="fa fa-check" />Medication management</li>
                                                <li><i className="fa fa-check" />Nutritional needs</li>
                                                <li><i className="fa fa-check" />Communication and interpersonal skills</li>
                                                <li><i className="fa fa-check" />Safety and emergency preparedness</li>
                                            </ul>
                                        </div>
                                    </div>
