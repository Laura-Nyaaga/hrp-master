...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Leadership Training" wrapperCls="home_1">
                <div>
                                ...
                                <div className="col-lg-8 content-side">
                                    ...
                                    <div className="row mb-5">
                                        ...
                                        <div className="col-md-7">
                                            <div className="text"><p>Our Leadership Training program equips you with the skills and knowledge to inspire, motivate, and empower others. </p></div>
                                            <ul className="list">
                                                <li><i className="fa fa-check" />Effective communication</li>
                                                <li><i className="fa fa-check" />Conflict resolution</li>
                                                <li><i className="fa fa-check" />Decision-making</li>
                                                <li><i className="fa fa-check" />Team building</li>
                                                <li><i className="fa fa-check" />Emotional intelligence</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <h5> Professionals and aspiring leaders seeking to develop and enhance their leadership skills in various organizational settings</h5>
                                    {/*Theme Carousel*/}
                                    {/* <ServiceSlider1 /> */}
                                    {/* <h2>Confidence in future</h2> */}
                                    <div className="text">This leadership training program can be offered in various formats, including intensive workshops, modular programs, or blended learning options, depending on the needs and preferences of the participants.</div>
                                    <ServiceTabs1 />
                                </div>
